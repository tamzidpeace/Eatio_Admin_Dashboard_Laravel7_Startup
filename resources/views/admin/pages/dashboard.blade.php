     ...
     <div class="row">
                              ...
                              <div class="row align-items-center mx-0">
                                   ...
                                   <div class="col-xl-9 col-lg-8 col-xxl-8 col-sm-8 px-0">
                                        ...
                                        <div class="d-flex align-items-center">
                                             ...
                                             <div class="progress mb-0" style="height:8px; width:100%;">
                                                  <div class="progress-bar bg-dark progress-animated"
          ...
          <div class="col-xl-3 col-xxl-3 col-lg-4 col-md-12">
               <div class="card bg-secondary"
                    style="background-image:url(images/bg-icon.png); background-repeat:no-repeat; background-position:top right;">
                    <div class="card-body p-5 mt-3">
                         <svg width="44" height="44" viewBox="0 0 44 44" class="mb-3" fill="none"
                              xmlns="http://www.w3.org/2000/svg">
                         ...
                         <a href="javascript:void(0);"
                              class="d-flex text-light align-items-center justify-content-between">
